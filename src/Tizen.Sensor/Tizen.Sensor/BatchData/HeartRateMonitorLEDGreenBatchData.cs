...
namespace Tizen.Sensor
{
    ...
    public class HeartRateMonitorLEDGreenBatchData : BatchData
    {
        ...
        public HeartRateMonitorLEDGreenBatchData(ulong timestamp, SensorDataAccuracy accuracy, uint green, uint accelerationX, uint accelerationY, uint accelerationZ, uint index) : base(timestamp, accuracy)
        {
            Green = green;
        ...
        /// <summary>
        /// Gets the X axis's uncalibrated value of the gravitational acceleration.
        /// </summary>
        /// <since_tizen> 8 </since_tizen>
        /// <value> AccelerationX </value>
        public uint AccelerationX { get; }

        /// <summary>
        /// Gets the Y axis's uncalibrated value of the gravitational acceleration.
        /// </summary>
        /// <since_tizen> 8 </since_tizen>
        /// <value> AccelerationY </value>
        public uint AccelerationY { get; }


        /// <summary>
        /// Gets the Z axis's uncalibrated value of the gravitational acceleration.
        /// </summary>
        /// <since_tizen> 8 </since_tizen>
        /// <value> AccelerationZ </value>
        public uint AccelerationZ { get; }
